...
class PageEntryLoader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return  Container(
      ...
      color: ColorResources.SCAFFOLDBGOLD,
      child:  Center(
        child:CircularProgressIndicator(color: primarycolor,strokeCap: StrokeCap.round,strokeWidth: 5,)
      ),
    );
  }
}
      ...
      child:  Center(
        child:Column(
          ...
          children: [
            ...
            gap,
            AppText(text: errortext??'',color: ColorResources.APPBARBG,weight: FontWeight.w500,letterspace: 0.6,)
          ],
        )
      ),
    );
